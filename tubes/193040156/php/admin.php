...
<body>
  ...
  <div class="container">
    <div class="add">
      <a href="tambah.php"><button id="tambah">Tambah Data</button></a><br>
      <a href="../index.php"><button id="tambah">Kembali</button></a>
    </div>

    <div class="logout">
      <a href="logout.php"><button id="tambah">Logout</button></a>
    </div> <br>
    ...
    <table border="1" cellpadding="13" cellspacing="0" class="table">
      ...
      <?php else : ?>
        ...
        <?php foreach ($laptop as $lp) : ?>
          ...
          <tr>
            <td id="tab"><?= $i; ?></td>
            <td><img src="../assets/gambar/<?= $lp['foto_produk']; ?>" alt="" class="gambar" width="150px"></td>
